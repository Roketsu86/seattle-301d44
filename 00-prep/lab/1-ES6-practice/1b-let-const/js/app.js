...
function displayPics(){
  ...
  // The variable "rando" was set using `let` in the while loop, and since let is scoped to the block it is in "rando" is not accessable outside of that while loop.
  console.log(viewed);
